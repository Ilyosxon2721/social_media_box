...
class LetterboxdScreen extends StatelessWidget {
  const LetterboxdScreen({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(
          ...
          child: screenControl.isLoaded.value
              ...
              : Image.asset(
                  'assets/icons/letterboxd-logo.png',
                  height: 64,
                  width: 128,
                ),
        ),
        body: InAppWebView(
          ...
          pullToRefreshController: screenControl.pullToRefreshController.value,
