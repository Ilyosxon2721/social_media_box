...
class SocialPanelScreen extends StatefulWidget {
  const SocialPanelScreen({Key? key}) : super(key: key);

  @override
  State<SocialPanelScreen> createState() => _SocialPanelScreenState();
}

class _SocialPanelScreenState extends State<SocialPanelScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Padding(
        ...
        child: Obx(() {
          final app =
              items.apps.where((element) => element.isSocial).toList().obs;
          return SizedBox(
            ...
            //       .where((element) => element['isSocial'])
            //       .map((e) => InkWell(
            //             key: ValueKey(e['isSocial'] ? e['title'] : ''),
            //             onTap: () async {
            //               if (controller.connectionStatus.value.name != 'none') {
            //                 if (e['isLock'].value) {
